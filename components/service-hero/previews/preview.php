...
$component_data['animation'] = 'people-grid-three'; 
?>
<?php ll_include_component('service-hero', $component_data, array("classes"=>array(),"id"=>"") );?>